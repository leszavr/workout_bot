...
import { Card, ErrorState, Field, Notice } from "@/components/ui/Primitives";
...
export default function ChangePasswordPage() {
  ...
  return (
    <>
      <PageHeader
        title="Смена пароля"
        description="Пароль меняется только владельцем записи: администратор может выдать временный, но не увидеть текущий."
      />
