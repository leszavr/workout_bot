...
#
# Верхняя граница покрывает и сравнение моделей (`compare_models`), где к базовым
# id прибавляется смещение до 1500: иначе созданные им анкеты остались бы в базе
# после `--cleanup`, и следующий прогон считал бы их своими.
QA_USER_ID_MIN = 990100
QA_USER_ID_MAX = 999999
