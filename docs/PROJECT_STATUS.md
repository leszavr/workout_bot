...
- **словарь оборудования пополнен, а не создан заново**: +3 записи (`bosu_ball`,
  `upper_body_ergometer`, `ski_ergometer`), +17 синонимов; итого 77 записей и 197
  синонимов. Пять значений источника (`weighted`, `assisted`, `rope`, `roller`,
...
- **результат**: каталог 873 → 1826 упражнений, техника 870 → 1823, русская
  ...
  выполнения), требования к оборудованию 803 → 1709, альтернатив 4067 → 8257;
